...
class ChatBot:
    ...
    def train_classifier(self):
        ...
        try:
            ...
            bag_of_words_array = csr_matrix(pd.DataFrame(bag_of_words))
            output_rows_array = csr_matrix(pd.DataFrame(output_rows))
            training_data = csr_matrix(pd.concat([bag_of_words_array, output_rows_array], axis=1))
