...
## Authentication in Google Cloud with Cloud IAM
...
- Step 06: Demo - Playing with IAM V2  
- Step 07  
- Step 08  
- Step 09: Exploring Service Account Use Cases V2  
- Step 10: Scenarios - Service Accounts  
- Step 11: Exploring Cloud Storage - ACL (Access Control Lists)  
- Step 12: Exploring Cloud Storage - Signed URLs  
- Step 13: Exposing a Public Website using Cloud Storage  
- Step 14: IAM - Scenarios  
- Quiz  
...
- Step 03a: Increasing Availability and Durability  
...
- Step 00: Section Introduction  
- Step 01: Getting Started with Cloud SQL  
- Cloud SQL Commands  
- Step 02: Demo - Playing with Cloud SQL  
- Step 03: Demo - Playing with Cloud SQL - Part 2  
- Step 04: Understanding Cloud SQL Features  
- Step 05: Understanding Cloud SQL High Availability Features  
- Step 06  
- Step 07: Getting Started with Cloud Spanner  
- Cloud Spanner - Table Creation Script  
- Step 08: Demo - Playing with Cloud Spanner V2  
- Quiz

## NoSQL Databases in Google Cloud Platform

- Step 00: Section Introduction  
- Step 01: Getting Started with Cloud Datastore and Cloud Firestore  
- Step 02: Demo - Playing with Firestore  
- Step 03: Understanding Cloud Datastore Best Practices  
- Step 04: Getting Started with Cloud BigTable  
- Step 05: Designing BigTable Tables  
- Step 06  
- Quiz

## Create Private Networks with Cloud VPC in GCP

- Step 02: Understanding the Need for VPC Subnets  
- Step 03: Creating VPCs and Subnets in Google Cloud Platform  
- Step 04: Understanding CIDR Blocks  
- Step 05: Demo - Creating VPCs and Subnets in GCP V2  
- Step 06: Understanding Firewall Rules in Google Cloud Platform  
- Step 07: Understanding Firewall Rules Best Practices  
- Step 08: Getting Started with Shared VPC  
- Step 09: Getting Started with VPC Peering  
- Quiz
...
- Step 07  
- Step 08: Getting Started with Google Cloud Error Reporting  
- Step 09: What is Stackdriver?  
- Step 10  
- Quiz

## Exploring IAM and Project Organizations in GCP

- Step 01  
- Step 02: Exploring Billing Accounts  
- Step 03  
- Step 04: Understanding User Identity Management in GCP  
- Step 05: Exploring IAM Members and Identities  
- Step 06: Understanding Organization Policy Service  
- Step 07: Exploring IAM Policy at Multiple Levels - Resource Hierarchy  
- Step 08: Exploring IAM Predefined Roles - Google Cloud BigQuery  
- Step 09: Corporate Directory Federation  
- Step 10: Exploring IAM Scenarios  
- Terminate Your VM Instances  
- Quiz

## Compute Engine Virtual Machines

- Step 01: SSHing into Linux VMs - Part 1  
- Step 02: SSHing into Linux VMs - Part 2  
